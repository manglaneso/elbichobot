...
function getLastDayIntraStockPrice(msg, companyCode='GOOG') {
  ...
  try {
    ...
    telegramApi.sendMessage({chatId: String(msg['chat']['id']), text: 'No se han podido obtener los datos para esa compañia', replyParameters: {'message_id': msg['message_id']}});
    return;
  }
  ...
  telegramApi.sendPhoto({chatId: String(msg['chat']['id']), photo: chart.getBlob()});      
}
